  ...
  return (
    ...
    <ImageBackground
      ...
      <View
        ...
        onChangeText={(text)=>{setemail(text)}} style={styles.input} placeholder="Email" placeholderTextColor="#9b9b9b"/> 
        <TextInput
        keyboardType='numeric'
         onChangeText={(text)=>{setpwd(text)}} style={styles.input} placeholder="Password" placeholderTextColor="#9b9b9b" secureTextEntry/> 
        ...
        title="Submit" color="#AEC16F" ></Button>
          </View>
          <View style={styles.buttonWrapper}>
